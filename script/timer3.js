...
function time_info(){
    ...
    if(distance<1800000 ){
        document.getElementById("relife").style.display="inherit";
        document.getElementById("click_here").style.display = "none";
    }else{
        document.getElementById("relife").style.display="none";
        document.getElementById("click_here").style.display = "inherit";
    }
